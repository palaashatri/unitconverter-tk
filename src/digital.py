...
def DigitalConverter(parent: tk.Widget, on_status=None) -> ttk.Frame:
    ids = {
        "Bit": "bit",
        "Byte": "byte",
        "Kilobyte": "kB",
    ...
    def callback(event=None):
        ...
        frm = ids[in_unit.get()]
        to = ids[out_unit.get()]
        out_amt.set(str(round(convert_digital.convert(amt, frm, to), 6)))
    ...
    ttk.Label(frame, text="Digital Converter", style="Header.TLabel").grid(row=0, column=0, columnspan=3, sticky="w", pady=(0, 12))
