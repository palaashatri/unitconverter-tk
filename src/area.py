...
def AreaConverter(parent: tk.Widget, on_status=None) -> ttk.Frame:
    ids = {
        "Square meter": "sqm",
        "Square km": "sqkm",
        "Square rood": "sqr",
        ...
        "Square rod": "sqrod",
        "Square yard": "sqyard",
        "Square township": "sqtownship",
        "Square acre": "sqacre",
        "Square are": "sqare",
        "Square barn": "sqbarn",
        "Square hectare": "sqhectare",
        "Square homestead": "sqhomestead",
    }
    ...
    def callback(event=None):
        ...
        frm = ids[in_unit.get()]
        to = ids[out_unit.get()]
        out_amt.set(str(round(convert_area.convert(amt, frm, to), 6)))
    ...
    ttk.Label(frame, text="Area Converter", style="Header.TLabel").grid(row=0, column=0, columnspan=3, sticky="w", pady=(0, 12))
